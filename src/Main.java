...
public class Main {
	...
	public void ArquivoLOG(PCB pcb) {
		...
		PrintWriter write = arq.escreveLog("log1-Geraldo-RR.txt");
	...
	public void ArquivoLOG2() {
		/* Segundo LOG */
		ArquivoUtils arq = new ArquivoUtils();
		PrintWriter write = arq.escreveLog("log2-Geraldo-RR.txt");
	...
	public void ArquivoLOG3() {
		/* Terceito LOG */
		ArquivoUtils arq = new ArquivoUtils();
		PrintWriter write = arq.escreveLog("log3-Geraldo-RR.txt");
		String algoritmo = "RR";
